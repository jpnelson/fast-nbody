...
public class BenchmarkDoubleDCT {
    ...
    public static void benchmarkForward_1D() {
        ...
        IOUtils.writeFFTBenchmarkResultsToFile("benchmarkDoubleForwardDCT_1D.txt", nthread, niter, doWarmup, doScaling, sizes1D, times);
    }
    ...
    public static void benchmarkForward_2D_input_1D() {
        ...
        IOUtils.writeFFTBenchmarkResultsToFile("benchmarkDoubleForwardDCT_2D_input_1D.txt", nthread, niter, doWarmup, doScaling, sizes2D, times);
    ...
    public static void benchmarkForward_2D_input_2D() {
        ...
        IOUtils.writeFFTBenchmarkResultsToFile("benchmarkDoubleForwardDCT_2D_input_2D.txt", nthread, niter, doWarmup, doScaling, sizes2D, times);
    ...
    public static void benchmarkForward_3D_input_1D() {
        ...
        IOUtils.writeFFTBenchmarkResultsToFile("benchmarkDoubleForwardDCT_3D_input_1D.txt", nthread, niter, doWarmup, doScaling, sizes3D, times);
    ...
    public static void benchmarkForward_3D_input_3D() {
        ...
        IOUtils.writeFFTBenchmarkResultsToFile("benchmarkDoubleForwardDCT_3D_input_3D.txt", nthread, niter, doWarmup, doScaling, sizes3D, times);
    }
