...
\begin{algorithm}
 \SetLine
 \KwData{$r_i$: particle positions, $q_i$: particle charges, N: number of particles, Q: output array of charges, initialised to zero}
 \For{i=0 to N}{
  \For{j=i to N}{
      \If{$i \not= j$}{
        $d := |r_i - r_j|$\;
...
\subsection{The algorithm}
\label{sec:fma_alg}
The basic flow of the \fma{} is given in Algorithm \ref{alg:fma}\\
%%%%%PSEUDOCODE%%%%%%%%%
\begin{algorithm}[H]
\SetLine
